    ...
    return (
        <div className="relative h-[600px] bg-cover bg-center overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center px-4">
                ...
                <h1 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold text-center mb-4 uppercase">
                    {t('hero.heroTitle')}
                </h1>

                <p className="text-white text-xl md:text-2xl font-serif italic text-center mb-10 max-w-3xl">
                    {t('hero.heroSubtitle')}
                </p>
                ...
                <form onSubmit={handleSearch} className="w-full max-w-3xl">
                    <div className="bg-white rounded-lg shadow-2xl p-2 flex flex-col md:flex-row gap-2">
                        ...
                        <button
                            type="submit"
                            className="bg-[var(--primary-orange)] text-white px-8 py-3 rounded-md hover:bg-[#e67a2e] transition-colors font-medium flex items-center justify-center gap-2"
                        >
            ...
            {/* Social Media Icons - Bottom Left Horizontal - WHITE BACKGROUND */}
            <div className="absolute bottom-8 left-8 z-20 flex gap-3">
                ...
                <a
                    ...
                    className="w-11 h-11 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg group"
                    title="Facebook"
                >
                ...
                {/* Email */}
                <a
                    href="mailto:contact@tabakhdziri.com"
                    className="w-11 h-11 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg group"
                    title="Email"
                >
                    <svg className="w-5 h-5 text-[var(--primary-orange)] group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
